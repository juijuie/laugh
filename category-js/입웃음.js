document.addEventListener("DOMContentLoaded", () => {
    const images = [
      ...
      { file: '확대/미소지기_확대.png', hoverFile: '팝업/미소지기_팝업.png', link: '', audio: 'mp3/', grayscale: 100, opacity: 1.0, border: '0px solid black', brightness: 1.0, overlay: false, text: '상세페이지 업데이트중..' },
      ...
      { file: '확대/팬암뒤센_확대.png', hoverFile: '팝업/팬암뒤센_팝업.png', link: '', audio: 'mp3/', grayscale: 100, opacity: 1.0, border: '0px solid black', brightness: 1.0, overlay: false, text: '상세페이지 업데이트중..' },
      { file: '확대/뒤센팬암_확대.png', hoverFile: '팝업/뒤센팬암_팝업.png', link: '', audio: 'mp3/', grayscale: 100, opacity: 1.0, border: '0px solid black', brightness: 1.0, overlay: false, text: '상세페이지 업데이트중..' },
      ...
      { file: '확대/미소세상_확대.png', hoverFile: '팝업/미소세상_팝업.png', link: '', audio: 'mp3/', grayscale: 100, opacity: 1.0, border: '0px solid black', brightness: 1.0, overlay: false, text: '상세페이지 업데이트중..' },
      ...
      { file: '확대/짱구_확대.png', hoverFile: '팝업/짱구_팝업.png', link: '짱구.html', audio: 'mp3/', grayscale: 100, opacity: 1.0, border: '0px solid black', brightness: 1.0, overlay: false, text: '상세페이지 업데이트중..' },
      { file: '확대/돼지_확대.png', hoverFile: '팝업/돼지_팝업.png', link: '', audio: 'mp3/', grayscale: 100, opacity: 1.0, border: '0px solid black', brightness: 1.0, overlay: false, text: '상세페이지 업데이트중..' },
